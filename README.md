...
The Resume Optimizer performs a bullet-by-bullet integrity check before generating any document. Any content that can't be traced directly to your source resume is removed before the file is written — no flags, no annotations, no residue.
